...
const AboutUs = () => {
   ...
   return (
      <div className="font-lexend bg-Radial bg-[#000000] text-white">
         {/* Header */}
         <header className="flex w-full h-20 items-center bg-Radial bg-[#000000]">
            <div className="flex items-center pl-8 w-3/5">
               <img
            ...
            <nav className="flex w-2/5 justify-around pr-8">
               <a
                  onClick={() => navigate("/")}
                  className="text-lg font-semibold hover:text-[#a83c70] cursor-pointer">
                  Home
               </a>
               <a
                  className="text-lg font-semibold hover:text-[#a83c70] cursor-pointer">
         ...
         {/* Main Content */}
         <div className="bg-Arial bg-opacity-60 px-8 py-10">
            <div className="py-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xl">
                  ...
                  <div>
                     <p className="text-justify">
                        <span className="font-bold">Curricular Student Organizations</span>{" "}
                        ...
                        through the conduct of special lecture series, symposia, exhibits
                        and other learning activities.
                     </p>
                  </div>
                  <div>
                     <p className="text-justify">
                        <span className="font-bold">Non-Curricular Student Organizations</span>{" "}
                        focus on extracurricular interests such as arts, culture,
                        leadership, and community service, including the University City
                        Scholars - USTP, and the Google Developer Student Clubs USTP. The
                        Arts and Culture Division falls into the category of
            ...
            <section className="py-10">
               <div id="about" className="mb-10 flex items-start">
                  ...
                  <p className="text-lg">
                     The Playmakers-USTP Music Organization, founded by Mark Gonzales in
                     2013 and currently having Engr. Jerry Halibas as a coordinator, is
                     part of the Arts and Culture Division. With its 80 dedicated
               ...
               <div id="events" className="mb-10 flex items-start">
                  ...
                  <p className="text-lg">
                     Playmakers manages around three to four events each month, which is
                     a significant workload considering the members are also students
                     with academic responsibilities and having a frequency of three
                     times a week practices for an upcoming event. Below is an example
                     of an event done by members.
                  </p>
               </div>
